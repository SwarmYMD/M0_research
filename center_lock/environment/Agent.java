...
public class Agent{
    ...
    public void dis2(Grid grid, Agent[] agents){
        int leftEnd, rightEnd;
        int upperEnd, lowerEnd;
    ...
    public void move_dis2(Grid grid, int leftEnd, int rightEnd, int upperEnd, int lowerEnd, Agent[] agents){
        // copy pheromone data of the area which this agent exists
        for(int i=upperEnd; i<=lowerEnd; i++){
            for(int j=leftEnd; j<=rightEnd; j++){
    ...
    public void check_dis2(Grid grid, int leftEnd, int rightEnd, int upperEnd, int lowerEnd, Agent[] agents, int mr, int mc){
        ArrayList<Integer> candiList = new ArrayList<Integer>();
        int change_pos;
        for(int i = 0; i < Variable.AGENT_NUM; i++){
            if(this != agents[i]){
    ...
    public void exp2(Grid grid, Agent[] agents){
        int leftEnd, rightEnd;
        int upperEnd, lowerEnd;
        leftEnd = (areaNo % second_m) * second_W;
        rightEnd = leftEnd + second_W - 1;
    ...
    public void move_exp2(Grid grid, Agent[] agents){
        for(int i=0; i<second_n; i++){
            for(int j=0; j<second_m; j++){
    ...
    public void check_exp2(Grid grid, Agent[] agents, int mr, int mc){
        ArrayList<Integer> candiList = new ArrayList<Integer>();
        int change_pos;
        //int unyo = 0;
        for(int i = 0; i < Variable.AGENT_NUM; i++){
