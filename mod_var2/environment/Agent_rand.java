...
public class Agent_rand{
    ...
    public void dispersion(Grid_rand grid, Agent_rand[] agents){
    ...
    public void move_dis(Grid_rand grid, int leftEnd, int rightEnd, int upperEnd, int lowerEnd, Agent_rand[] agents){
    ...
    public void check_dis(Grid_rand grid, int leftEnd, int rightEnd, int upperEnd, int lowerEnd, Agent_rand[] agents, int mr, int mc){
    ...
    public void exploration(Grid_rand grid, Agent_rand[] agents){
        int leftEnd, rightEnd;
        int upperEnd, lowerEnd;
        leftEnd = (areaNo % Variable.m) * Variable.W;
        rightEnd = leftEnd + Variable.W - 1;
    ...
    public void move_exp(Grid_rand grid, Agent_rand[] agents){
        for(int i=0; i<Variable.n; i++){
            for(int j=0; j<Variable.m; j++){
    ...
    public void check_exp(Grid_rand grid, Agent_rand[] agents, int mr, int mc){
        ArrayList<Integer> candiList = new ArrayList<Integer>();
        int change_pos;
        //int unyo = 0;
        for(int i = 0; i < Variable.AGENT_NUM; i++){
    ...
    public void dis2(Grid_rand grid, Agent_rand[] agents){
        int leftEnd, rightEnd;
        int upperEnd, lowerEnd;
    ...
    public void move_dis2(Grid_rand grid, int leftEnd, int rightEnd, int upperEnd, int lowerEnd, Agent_rand[] agents){
        // copy pheromone data of the area which this agent exists
        for(int i=upperEnd; i<=lowerEnd; i++){
            for(int j=leftEnd; j<=rightEnd; j++){
    ...
    public void check_dis2(Grid_rand grid, int leftEnd, int rightEnd, int upperEnd, int lowerEnd, Agent_rand[] agents, int mr, int mc){
        ArrayList<Integer> candiList = new ArrayList<Integer>();
        int change_pos;
        for(int i = 0; i < Variable.AGENT_NUM; i++){
            if(this != agents[i]){
    ...
    public void exp2(Grid_rand grid, Agent_rand[] agents){
        int leftEnd, rightEnd;
        int upperEnd, lowerEnd;
        leftEnd = (areaNo % second_m) * second_W;
        rightEnd = leftEnd + second_W - 1;
    ...
    public void move_exp2(Grid_rand grid, Agent_rand[] agents){
        for(int i=0; i<second_n; i++){
            for(int j=0; j<second_m; j++){
    ...
    public void check_exp2(Grid_rand grid, Agent_rand[] agents, int mr, int mc){
        ArrayList<Integer> candiList = new ArrayList<Integer>();
        int change_pos;
        //int unyo = 0;
        for(int i = 0; i < Variable.AGENT_NUM; i++){
