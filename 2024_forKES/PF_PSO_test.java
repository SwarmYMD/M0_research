    ...
    public static void main(String[] args) {
        for(int n=0; n<10; n++){
            ...
            */
            ...
            try{
                FileWriter f = new FileWriter("./"+String.valueOf(n+1)+"/csv_test/step0.csv");
                ...
                FileWriter agent_recorder = new FileWriter("./"+String.valueOf(n+1)+"/percent/agent.csv");
                ...
                //for(int i=0; i<10; i++){
                    ...
                    */
                    ...
                    fw[i] = new FileWriter("./"+String.valueOf(n+1)+"/csv_test/step"+String.valueOf(i+1)+".csv");
                    for (int j=0; j<Variable.AGENT_NUM; j++){
                        fw[i].append(String.valueOf(agents[j].col));
                        fw[i].append(",");
                        fw[i].append(String.valueOf(agents[j].row));
                ...
                FileWriter critic_recorder = new FileWriter("./"+String.valueOf(n+1)+"/percent/critic.csv");
