...
import environment.Grid_avoid;
import environment.Agent_avoid;
...
public class PF_PSO_avoid{
    public static void main(String[] args) {
        for(int n=0; n<10; n++){
            Grid_avoid grid = new Grid_avoid();
            ...
            */
            ...
            try{
                FileWriter f = new FileWriter("./"+String.valueOf(n+1)+"/csv_avoid/step0.csv");
                ...
                FileWriter percent_recorder = new FileWriter("./"+String.valueOf(n+1)+"/percent_avoid/percent.csv");
                FileWriter agent_recorder = new FileWriter("./"+String.valueOf(n+1)+"/percent_avoid/agent.csv");
                ...
                //for(int i=0; ; i++){
                //for(int i=0; i<10; i++){
                    //fw[i] = new FileWriter("./csv_avoid/step"+String.valueOf(i+1)+".csv");
                    ...
                    */
                    ...
                    fw[i] = new FileWriter("./"+String.valueOf(n+1)+"/csv_avoid/step"+String.valueOf(i+1)+".csv");
                    for (int j=0; j<Variable.AGENT_NUM; j++){
                        fw[i].append(String.valueOf(agents[j].col));
                        fw[i].append(",");
                        fw[i].append(String.valueOf(agents[j].row));
                ...
                FileWriter critic_recorder = new FileWriter("./"+String.valueOf(n+1)+"/percent_avoid/critic.csv");
    ...
    public static void calc_sum_pher(Agent_avoid[] agents, Agent_avoid r, Grid_avoid grid) {
        r.sum_pher = 0;
