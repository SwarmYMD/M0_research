        ...
        for(int n=0; n<1; n++){
            ...
            */
            ...
            try{
                ...
                FileWriter percent_recorder = new FileWriter("./"+String.valueOf(n+1)+"/percent_origin/percent.csv");
                FileWriter agent_recorder = new FileWriter("./"+String.valueOf(n+1)+"/percent_origin/agent.csv");
                ...
                FileWriter critic_recorder = new FileWriter("./"+String.valueOf(n+1)+"/percent_origin/critic.csv");
