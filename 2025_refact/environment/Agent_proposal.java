...
public class Agent_proposal{
    ...
    public void move_exp(Grid_proposal grid, Agent_proposal[] agents){
        ...
        if(next_area != pre_next_area){
            objPos = decideAreaPos();
        }

        pre_next_area = next_area;
        ...
        // determine pgd
        pgd_col = area_c*Variable.W + objPos % Variable.W;
        pgd_row = area_r*Variable.H + objPos / Variable.W;
    ...
    public void move_exp2(Grid_proposal grid, Agent_proposal[] agents){
        ...
        // determine pgd
        pgd_col = area_c*second_W + objPos % second_W;
        pgd_row = area_r*second_H + objPos / second_W;
    ...
    public static int decideAreaPos() {
        int pos = 0;

        pos = random.nextInt(Variable.H * Variable.W);
