...
public class PF_PSO_proposal{
    public static void main(String[] args) {
        ...
        */
        ...
        try{
            FileWriter f = new FileWriter("./csv_proposal/step0.csv");
            ...
            FileWriter percent_recorder = new FileWriter("./percent_proposal/percent.csv");
            FileWriter agent_recorder = new FileWriter("./percent_proposal/agent.csv");
            ...
            FileWriter critic_recorder = new FileWriter("./percent_proposal/critic.csv");
