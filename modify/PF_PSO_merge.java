...
import environment.Grid_merge;
import environment.Agent_merge;
...
public class PF_PSO_merge{
    public static void main(String[] args) {
        Grid_merge grid = new Grid_merge();
        ...
        Agent_merge[] agents = new Agent_merge[Variable.AGENT_NUM];
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
            ...
            while ((line = reader.readLine()) != null) {
                if (index >= 0) {
                    ...
                    agents[index] = new Agent_merge(Integer.parseInt(data[0]), Integer.parseInt(data[1]));
        ...
        */
        ...
        try{
            FileWriter f = new FileWriter("./csv_merge/step0.csv");
            ...
            FileWriter percent_recorder = new FileWriter("./percent_merge/percent.csv");
            FileWriter agent_recorder = new FileWriter("./percent_merge/agent.csv");
            ...
            //for(int i=0; ; i++){
            //for(int i=0; i<10; i++){
                //fw[i] = new FileWriter("./csv_merge/step"+String.valueOf(i+1)+".csv");
            ...
            FileWriter critic_recorder = new FileWriter("./percent_merge/critic.csv");
    ...
    public static void calc_sum_pher(Agent_merge[] agents, Agent_merge r, Grid_merge grid) {
        r.sum_pher = 0;
