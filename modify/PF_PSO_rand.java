...
import environment.Grid_rand;
import environment.Agent_rand;
...
public class PF_PSO_rand{
    public static void main(String[] args) {
        Grid_rand grid = new Grid_rand();
        ...
        Agent_rand[] agents = new Agent_rand[Variable.AGENT_NUM];
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
            ...
            while ((line = reader.readLine()) != null) {
                if (index >= 0) {
                    ...
                    agents[index] = new Agent_rand(Integer.parseInt(data[0]), Integer.parseInt(data[1]));
        ...
        */
        ...
        try{
            FileWriter f = new FileWriter("./csv_rand/step0.csv");
            ...
            FileWriter percent_recorder = new FileWriter("./percent_rand/percent.csv");
            FileWriter agent_recorder = new FileWriter("./percent_rand/agent.csv");
            ...
            //for(int i=0; ; i++){
            //for(int i=0; i<10; i++){
                //fw[i] = new FileWriter("./csv_rand/step"+String.valueOf(i+1)+".csv");
            ...
            FileWriter critic_recorder = new FileWriter("./percent_rand/critic.csv");
    ...
    public static void calc_sum_pher(Agent_rand[] agents, Agent_rand r, Grid_rand grid) {
        r.sum_pher = 0;
