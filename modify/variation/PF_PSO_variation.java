...
public class PF_PSO_variation{
    public static void main(String[] args) {
        ...
        */
        ...
        try{
            FileWriter f = new FileWriter("./csv_var/step0.csv");
            ...
            FileWriter percent_recorder = new FileWriter("./percent_var/percent.csv");
            FileWriter agent_recorder = new FileWriter("./percent_var/agent.csv");
            ...
            //for(int i=0; ; i++){
            //for(int i=0; i<10; i++){
                //fw[i] = new FileWriter("./csv_var/step"+String.valueOf(i+1)+".csv");
                
                System.out.printf("Now: step %d\n", i+1);
                
                for (int j=0; j<Variable.AGENT_NUM; j++){
                    if(i < Variable.maxStep/2){
            ...
            FileWriter critic_recorder = new FileWriter("./percent_var/critic.csv");
            ...
            System.out.printf("critic : %d\n", not_count + out_count);
                            ...
                            for(int k=0; k<Variable.n/5; k++){
                                for(int s=0; s<Variable.m/5; s++){
                                    System.out.printf("%f\t",grid.areaPherData2[k][s]);
                                }
                                System.out.println();
                            }
        } catch (Exception e) {
